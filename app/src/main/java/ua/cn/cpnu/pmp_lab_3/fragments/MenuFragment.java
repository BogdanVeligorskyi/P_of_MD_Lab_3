...
public class MenuFragment extends BaseFragment {
    ...
    public void onViewCreated(@NonNull View view,
        ...
        view.findViewById(R.id.options_button)
                .setOnClickListener(v -> getAppContract().
                        toOptionsScreen(this, options));
        ...
        getPlayButton.setOnClickListener(v -> getAppContract().
                toPlayScreen(this, options, arrQuestions));
        updateView();
    }
    ...
    private final ResponseListener<Options> listener =
